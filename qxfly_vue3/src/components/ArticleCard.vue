        ...
        <div class="item-info" :id="'item-info-' + article.id">
          ...
          <div class="item-actions" v-if="article.createTime != null">
            ...
            <div class="item-action-item item-action-views">
              <span class="item-action-label" v-if="isDisPlayActionLabel()">浏览:</span>{{ article.views }}
            </div>
            <div class="item-action-item item-action-likes">
              <span class="item-action-label" v-if="isDisPlayActionLabel()">点赞:</span>{{ article.likes }}
            </div>
            <div
              class="item-action-item item-action-classify"
              v-if="article.classify != null && article.classify != ''">
              <span class="item-action-label" v-if="isDisPlayActionLabel()">分类:</span>{{ article.classify }}
            </div>
...
async function ArticleDetail(article) {
  var id = article.id;
  if (id == null) return;
