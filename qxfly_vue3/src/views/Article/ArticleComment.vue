  ...
  <div>
    <div class="comments">
      ...
      <div class="release-comment">
        ...
        <button class="release-comment-btn" @click="ReleaseComment()">
          发布
        </button>
      </div>
        ...
        <div class="comment-list">
            ...
            <div class="comment-item-content">
              <div class="comment-header">
                <div
                  ...
                  v-text="comment.user.username"></div>
                <div class="comment-header-right">
                  ...
                  <div
                    class="comment-time"
                    v-text="adjustTime(comment.createTime)"></div>
                </div>
              </div>
              ...
              <div class="comment-actions">
                ...
                <div
                  ...
                  @click="actionItemComment(comment.id, 0)">
                  评论
                </div>
              ...
              <div
                ...
                v-if="comment.childComment.length != 0">
                <p
                  style="font-size: 14px; font-weight: 700; padding-left: 10px">
                  相关回复：
                </p>
                <div class="child-comments-items" :id="'comment-' + comment.id">
                  <div
                    ...
                    :key="chComment">
                    <div
                      class="comment-userImg"
                      @click="toUserSpace(chComment)">
                    ...
                    <div class="comment-item-content">
                      <div class="comment-header child">
                        <div class="comment-username child">
                          ...
                          <span style="font-weight: 500; margin: 0 4px"
                            >回复:</span
                          >
                          <div class="comment-username-item">
                            {{
                      ...
                      <p
                        class="comment-content child"
                        v-text="chComment.content"></p>
                      <div class="comment-actions">
                        <div
                          class="action-item likes"
                ...
                <button
                  ...
                  v-if="
                    comment.childComment.length > 2 ||
                    getChildCommentHeight(comment.id)
                  ">
                  展开评论
                </button>
              </div>
          ...
          <div
            ...
            <div
              ...
              <div style="margin: 0 auto">暂无评论,请发表你的评论吧！</div>
            </div>
          </div>
        </div>
      </div>
...
function adjustTime(time) {
  if (time != null)
    return time.split("T")[1].split(".")[0] + " / " + time.split("T")[0];
