    ...
    <el-header class="header">
      <div class="search-bar">
        <div class="search-items">
          <el-input class="search-item" v-model="navId" placeholder="导航ID" clearable style="width: 160px"></el-input>
          <el-input class="search-item" v-model="name" placeholder="导航标题" clearable style="width: 160px"></el-input>
      ...
      <div class="menu">
        <el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" @select="handleSelect">
          ...
          <el-menu-item index="5" @click="toListNavigation('workspace')">工作空间</el-menu-item>
      ...
      <div>
        <el-table
          ...
          <el-table-column prop="" label="操作" width="200" align="center">
            <template #default="scope">
              <el-button type="primary" size="small" plain @click="UpdateNavigation(scope.row)"> 编辑 </el-button>
              <el-button type="danger" size="small" plain @click="DeleteNavigation(scope.row)"> 删除 </el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
  ...
  <el-dialog
    ...
    <div class="update-dialog-item">
      ...
      <el-select class="search-item" v-model="addNavObj.type" style="width: 160px" placeholder="类别">
        ...
        <el-option value="workspace" label="工作空间">工作空间</el-option>
      </el-select>
    </div>
    <div class="update-dialog-item">
      <el-input style="width: 100px">
  ...
  <el-dialog
    ...
    <div>
      ...
      <div class="update-dialog-item">
        ...
        <el-select class="search-item" v-model="updateNav.parent" style="width: 160px" :placeholder="updateNav.parent">
