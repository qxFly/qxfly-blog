      ...
      <div class="search-bar">
        <div class="search-items">
          ...
          <el-input
            ...
            clearable
            style="width: 160px"></el-input>
          <el-button class="search-item" type="primary" @click="ListInventory()" style="margin: 0">筛选</el-button>
          <el-button class="search-item" @click="clearAll" style="margin: 0">清空筛选</el-button>
          <el-button class="search-item" type="primary" @click="warehouseDialog = true" style="margin: 0"
            >入库</el-button
          >
          <el-button class="search-item" type="primary" @click="GetExcel" style="margin: 0">导出Excel</el-button>
        </div>
      </div>
    </el-header>
    <el-main class="main">
          ...
          <el-form :rules="rules" ref="formRef" :model="warehouse">
            <div class="warehousingDialog-content">
              ...
              <el-form-item prop="unit">
                <el-input clearable rows="2" v-model="warehouse.unit">
                  <template #prepend>
      ...
      <div v-if="viewPictureDialogVisible">
        ...
        <el-dialog
          ...
          <div class="DialogContent">
            <el-image :src="picture" fit="contain" style="width: 50%" />
          </div>
  ...
  formRef.value.validate((valid) => {
    if (valid) {
      editWarehouse(warehouse.value).then((res) => {
        if (res.data.code == 0) {
          ElMessage.error("错误，" + res.data.msg);
        } else {
